...
def show_home():
    ...
    tools = [
        {"name": "Container Dashboard", "icon": "📊", "desc": "Tableau de bord des indicateurs et KPIs fournisseur", "path": "container-dashboard/app.py"},
        ...
        {"name": "Comparateur BOM vs BOM", "icon": "🔄", "desc": "Analyse et comparaison des versions BOM", "path": "comparator-bom_bom/app.py"},
        {"name": "Check Position", "icon": "📍", "desc": "Verification des positions et emplacements", "path": "check_position/app.py"},
        {"name": "Checking Reply", "icon": "✅", "desc": "Verification et analyse des reponses fournisseur", "path": "checking-reply/app.py"}
    ]
